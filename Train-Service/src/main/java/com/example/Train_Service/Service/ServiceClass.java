...
public class ServiceClass {
    ...
    private final TrainDetailsRepo trainDetailsRepo;

    private final StationDetailsRepo stationDetailsRepo;

    private final TrainStoppingStationRepo trainStoppingStationRepo;

    private final TrainCoachesRepo trainCoachesRepo;

    private final TrainReservationSystemRepo trainReservationSystemRepo;
...
//    public void addNormalTicktsForNextThirtyDay(List<Integer> trainNumbersList) {
//        List<TrainDetails> trainDetailsList = trainDetailsRepo.findAllByTrainNumber(trainNumbersList);
...
//                if (dayOfWeekList.contains(date.getDayOfWeek())) {
//                    matchingDates.add(date);
//                    logger.info("matchingDates.add(date):{}", date);
//                }
//            }
//        }
//        for (TrainRunningDays trainRunningDays : trainRunningDaysList) {
//            DayOfWeek day = DayOfWeek.valueOf(trainRunningDays.getDay().toUpperCase());
//            logger.info("DayOfWeek:{}", day);
//            dayOfWeekList.add(day);
//            logger.info("dayOfWeekList.add(day);");
//        }
